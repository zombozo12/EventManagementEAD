<?php
    ...
    if($sessionManager->get('current_user') != 'admin'){
        header('location: ../application/index.php');
        return;
    }
	...
	<div class="header clearfix">
		<div class="header-right">
			<div class="brand-logo">
				<a href="index.php">
					<img src="../application/img/icon-ead.png" alt="" class="mobile-logo">
				</a>
			</div>
			<div class="menu-icon">
				<span></span>
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name"><?php echo $sessionManager->get('current_user'); ?></span>
					</a>
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item" href="../application/logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Log Out</a>
					</div>
				</div>
			</div>
